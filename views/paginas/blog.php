    ...
    <article class="entrada-blog">
        ...
        <div class="texto-entrada">
            <a href="/entrada">
                ...
                <p>
                    Maximiza el espacio de tu hogar con esta guia, aprende a combinar muebles y colores para darle vida a tu
                    espacio
                </p>
            </a>
        </div>
    ...
    <article class="entrada-blog">
        <div class="imagen">
            <picture>
                ...
                <img loading="lazy" src="build/img/blog3.jpg" alt="Texto de entrada blog" width="500" height="300" />
            </picture>
        </div>
        <div class="texto-entrada">
            <a href="/entrada">
    ...
    <article class="entrada-blog">
        <div class="imagen">
            <picture>
                ...
                <img loading="lazy" src="build/img/blog4.jpg" alt="Texto de entrada blog" width="500" height="300" />
            </picture>
        </div>
        <div class="texto-entrada">
            <a href="/entrada">
